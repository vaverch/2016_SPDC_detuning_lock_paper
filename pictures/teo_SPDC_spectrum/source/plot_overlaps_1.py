...
#Delta_idler = 3
  fig1 = plt.figure(1,figsize=(6./2.55, 4.3/2.55))
  ...
  ax1_handle = ax1.plot(Delta,lor_signal,'-r', lw=0.8,label = 'signal')
  ax2_handle = ax1.plot(Delta,lor_idler,'-b', lw=0.8,label = 'idler')
  ...
  if g_use_tex == True:
    ax1.set_xlabel('\\textrm{Frequency detuning} $(\\nu - \\nu_\\textrm{s})$',**label_font)
